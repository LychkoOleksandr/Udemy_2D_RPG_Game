...
public class Player : Entity
{
    ...
    [Header("Movement details")] public float moveSpeed = 8f;
    public float jumpForce = 14f;
    public Vector2 wallJumpForce;
    [Range(0, 1)] public float inAirMoveMultiplier = .7f;
    [Range(0, 1)] public float wallSlideSlowMultiplier = .4f;
    ...
    private void OnEnable()
    {
        ...
        input.Player.Movement.canceled += _ => moveInput = Vector2.zero;
